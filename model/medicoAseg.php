      ...
      public function addmedAseguradora ($medico,$aseguradora, $usuario, $contraseña)
        {
            ...
            //Modificar Query del drive, Le  falta la R a passwordAseguradora 
            parent::query('insert into Usuario_has_Aseguradora(Usuario_idUsuario, Aseguradora_idAseguradora, usuarioAseguradora,passwordAseguradora) values("'.$medic.'","'.$asegurad.'", "'.$usuario.'",
                  "'.$contrase.'")');
            parent::cerrar();
      }
