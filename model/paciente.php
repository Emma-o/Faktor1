...
#Creacion de la clase Paciente con una herencia de la clase Conexion
 class Paciente extends Conexion {
      ...
      public function addPaciente ($nombre, $apellidop, $apellidom, $hospital, $chospital, $numtel, $email)
      {
      	...
      	parent::query('insert into Paciente (nombrePaciente, apellidoPatPaciente, apellidoMatPaciente, hospital ,cuartoHospital, numTelefonoPaciente, emailPaciente,Usuario_idUsuario) values("'.$nombre.'", "'.$apellidop.'", "'.$apellidom.'", "'.$hospital.'", "'.$chospital.'", "'.$numtel.'", "'.$email.'",
                  "'.$_SESSION['idUsuario'].'")');
